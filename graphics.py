...
class GraphWin(tk.Canvas):
    ...
    def plotPixel(self, x: float, y: float, color="black"):
    ...
    def toWorld(self, x: float, y: float) -> (float, float):
        trans = self.trans
        if trans:
...
class _BBox(GraphicsObject):
    ...
    def getP1(self) -> Point: return self.p1.clone()

    def getP2(self) -> Point: return self.p2.clone()
...
class Entry(GraphicsObject):
    ...
    def __init__(self, p: Point, width: float):
